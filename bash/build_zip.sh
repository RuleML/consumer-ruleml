...
zip -9 "${ZIP_HOME}ConsumerRuleML1.02.zip" "${DREPO_HOME}relaxng/modules/unordered_groups_expansion_module.rnc"
zip -9 "${ZIP_HOME}ConsumerRuleML1.02.zip" "${DREPO_HOME}relaxng/modules/ordered_groups_expansion_module.rnc"
zip -9 "${ZIP_HOME}ConsumerRuleML1.02.zip" "${DREPO_HOME}relaxng/modules/unordered_deterministic_groups_expansion_module.rnc"
